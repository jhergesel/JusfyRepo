...
var m = require("object-assign"),
    ...
    A = r ? Symbol["for"]("react.forward_ref") :
    60112,
...
function L(a, b, e) {
    var c = void 0,
        ...
        h = null;
    if (null != b)
        for (c in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (g = "" + b.key), b) J.call(b, c) && !K.hasOwnProperty(c) && (d[c] = b[c]);
...
function R(a, b, e, c) {
    ...
    if (Array.isArray(a))
        for (var h = 0; h < a.length; h++) {
            ...
            for (a = f.call(a),
                h = 0; !(d = a.next()).done;) d = d.value, f = b + S(d, h++), g += R(d, f, e, c);
