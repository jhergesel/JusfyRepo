...
export default class PaginationBoxView extends Component {
    ...
    getPageElement(index) {
        ...
        return ( <
            ...
            pageSelectedHandler = {
                this.handlePageSelected.bind(null, index)
            }
            selected = {
                selected === index
            }
            rel = {
                this.getElementPageRel(index)
            }
            pageClassName = {
                pageClassName
            }
            ...
            href = {
                this.getElementHref(index)
            }
            ariaLabel = {
                this.ariaLabelBuilder(index)
            }
            page = {
                index + 1
            }
            ...
            for (index = 0; index < pageCount; index++) {
                ...
                if (
                    ...
                    breakView = ( <
                        ...
                        breakHandler = {
                            this.handleBreakClick.bind(null, index)
                        }
                        getEventListener = {
                            this.getEventListener
                        }
    ...
    render() {
      ...
      isNextDisabled ? ` ${classNameIfDefined(disabledLinkClassName)}` : ''
        ...
        return ( <
            ...
            href = {
                this.getElementHref(selected - 1)
            }
            tabIndex = {
                isPreviousDisabled ? '-1' : '0'
            }
            role = "button"
            onKeyPress = {
