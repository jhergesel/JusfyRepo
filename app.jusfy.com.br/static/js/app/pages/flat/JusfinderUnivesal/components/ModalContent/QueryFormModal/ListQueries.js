...
export const ListQueries = ({
    ...
    const qtdQueries =
        creditAvailable > QUANTITY_QUERIES_CREDITS ?
        QUANTITY_QUERIES_CREDITS :
        creditAvailable;
    const msg = {
        ERROR_CREDIT: `Você tem apenas ${creditAvailable} créditos, escolha até ${qtdQueries} consultas a serem realizadas`,
    ...
    return ( <
        ...
        /ContentQueries> {
            hasInputError &&
                ...
                ) : creditAvailable <= queries.length ||
                queries.length < creditAvailable ? null : ( <
                    S.Error > {
