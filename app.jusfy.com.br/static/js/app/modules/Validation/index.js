...
export default function Validation(props) {
    ...
    const is_activating_account = useSelector(
        state => state.app.is_activating_account
    );
    const account_activation_response = useSelector(
        state => state.app.account_activation_response
    );
    useEffect(() => {
        dispatch({
                ...
                _SvgComponent / > {
                    ...
                    !account_activation_response.success && ( <
                        h1 style = {
                            ...
                            account_activation_response.msg
                        } <
                        /h1>
                    )
                } <
