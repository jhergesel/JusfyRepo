...
export default function RequestPasswordReset(props) {
    ...
    const loading_request_reset = useSelector(
        state => state.resetPassword.loading_request_reset
    );
    const request_reset_data = useSelector(
        state => state.resetPassword.request_reset_data
    );
    const resetar = () => {
        if (email == "") {
    ...
    return ( <
        ...
        {
            Object.keys(request_reset_data).length > 0 &&
            request_reset_data.success && ( <
                div className = "mb-10 alert alert-custom alert-light-success alert-dismissible" >
                <
                div className = "alert-text font-weight-bold" >
                Sucesso!Foi enviado um e - mail com as instruções para resetar sua senha. <
                /div> <
                /div>
            )
        } {
        ...
        Digite o seu e - mail para resetar a sua senha. <
        /div> <
        /div> <
