...
export function HeaderMobile() {
    ...
    return ( <
        ...
        className = {
            `header-mobile align-items-center ${layoutProps.headerMobileCssClasses}`
        ...
        div className = "d-flex align-items-center" > {
            layoutProps.asideDisplay && ( <
                ...
                span / >
                <
                /button> { /*end::Aside Mobile Toggle*/ } <
                />
            )
        }

        {
            layoutProps.headerMenuSelfDisplay && ( <
                ...
                span / >
                <
                /button> { /*end::Header Menu Mobile Toggle*/ } <
                />
            )
        }
        ...
        <
        SVG src = {
            toAbsoluteUrl("/media/svg/icons/General/User.svg")
        }
        /> <
        /span> <
        /button> { /*end::Topbar Mobile Toggle*/ } <
        /div> { /*end::Toolbar*/ } <
