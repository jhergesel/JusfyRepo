...
export function MyCartDropdown() {
    ...
    return ( <
        ...
        overlay = { < Tooltip id = "mycart-panel-tooltip" > User Cart < /Tooltip>} >
            ...
            <
            SVG src = {
                toAbsoluteUrl("/media/svg/icons/Shopping/Cart3.svg")
            }
            /> <
            /span> <
            /div> <
            ...
            img
            src = {
                toAbsoluteUrl("/media/stock-600x400/img-1.jpg")
            }
            alt = "" /
            >
            <
            ...
            SmartCleaner <
            /a> <
            span className = "text-muted" > Smart tool
            for cooking < /span> <
            div className = "d-flex align-items-center mt-2" >
            <
            span className = "font-weight-bold mr-1 text-dark-75 font-size-3" >
            ...
            img
            src = {
                toAbsoluteUrl("/media/stock-600x400/img-2.jpg")
            }
            alt = "" /
            >
            <
            ...
            img
            src = {
                toAbsoluteUrl("/media/stock-600x400/img-3.jpg")
            }
            alt = "" /
            >
            <
            ...
            img
            src = {
                toAbsoluteUrl("/media/stock-600x400/img-4.jpg")
            }
            alt = "" /
            >
            <
