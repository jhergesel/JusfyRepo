...
export function QuickActionsDropdown() {
    ...
    const layoutProps = useMemo(() => {
        return {
            offcanvas: objectPath.get(uiService.config, "extras.quick-actions.layout") ===
                "offcanvas",
        };
    }, [uiService]);
        ...
        > {
            layoutProps.offcanvas && ( <
                ...
                overlay = { < Tooltip id = "quick-actions-tooltip" > Quick actions < /Tooltip>} >
                    ...
                    SVG
                    src = {
                        toAbsoluteUrl("/media/svg/icons/Media/Equalizer.svg")
                    }
                    /> <
                    /span> <
                    /div> <
                ...
                !layoutProps.offcanvas && ( <
                    ...
                    <
                    form > { /* begin: Head */ } <
                    div className = "d-flex flex-column align-items-center justify-content-center pt-10 pb-10 bgi-size-cover bgi-no-repeat rounded-top"
                    style = {
                        {
