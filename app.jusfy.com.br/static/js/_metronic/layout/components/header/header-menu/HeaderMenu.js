...
export function HeaderMenu({
    ...
    return ( <
        ...
        className = {
            `header-menu header-menu-mobile ${layoutProps.ktMenuClasses}`
        ...
        li className = {
            `menu-item menu-item-rel ${getMenuItemActive(
            "/dashboard"
          )}`
        } >
        <
        ...
        { /*Classic submenu*/ } { /*begin::1 Level*/ } <
        li data - menu - toggle = {
            layoutProps.menuDesktopToggle
        }
        aria - haspopup = "true"
        className = {
            `menu-item menu-item-submenu menu-item-rel ${getMenuItemActive(
            "/google-material"
          )}`
        } >
        <
        ...
        <
        ul className = "menu-subnav" > { /*begin::2 Level*/ } <
        li className = {
        ...
        <
        ul className = "menu-subnav" > { /*begin::3 Level*/ } <
        li className = {
        ...
        <
        SVG src = {
            toAbsoluteUrl("/media/svg/icons/Devices/iMac.svg")
        }
        /> <
        /span> <
        ...
        i className = "menu-arrow" > < /i> <
        /h3> <
        ul className = "menu-inner" > { /*begin::3 Level*/ } <
        li className = {
            `menu-item ${getMenuItemActive(
                        "/react-bootstrap/pagina1"
                      )}`
        } >
        <
        NavLink className = "menu-link"
        to = "/react-bootstrap/pagina1" >
        <
        ...
        { /*begin::2 Level*/ } <
        li className = {
            `menu-item ${getMenuItemActive("/builder")}`
        } >
        <
        NavLink className = "menu-link"
        to = "/builder" >
