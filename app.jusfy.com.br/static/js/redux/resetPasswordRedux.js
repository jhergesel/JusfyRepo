...
export const reducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        case "REQUEST_RESET_PASSWORD_SUCCESS":
            return {
                ...state,
                request_reset_data: action.payload,
                loading_request_reset: false,
            };
        ...
        case "REQUEST_RESET_PASSWORD":
            return { ...state,
                request_reset_data: {},
                loading_request_reset: true
            };
        case "RESET_PASSWORD_SUCCESS":
            return {
                ...state,
                reset_password_data: action.payload,
                loading_reset_password: false,
            };
...
function* requestResetPassword({
    ...
    try {
        const response = yield axios.post(
            `${config.jusfyBackend.apiUrl}/auth/request_reset`,
            payload.data
        );
        yield put({
        ...
        toast.error(
            ...
            "Ocorreu um erro ao tentar resetar sua senha."
        );
    }
}
...
function* resetPassword({
    ...
    try {
        const response = yield axios.post(
            `${config.jusfyBackend.apiUrl}/auth/reset_password`,
            payload.data
        );
        yield put({
