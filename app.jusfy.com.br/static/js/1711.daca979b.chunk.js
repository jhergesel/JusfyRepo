        ...
        1711: function(e, n, t) {
            ...
            function y(e) {
                return e.reduce(function(e, n) {
                    return (0, a.fX)((0, a.fX)([], (0, a.zs)(e), !1), (0, a.zs)(Array.isArray(n) ? y(n) : [n]), !1)
                }, [])
            }
            ...
            function L(e, n) {
                var t = "application/x-moz-file" === e.type || (0, O.A)(e, n);
                return [t, t ? null : T(n)]
            }
            ...
            function H(e, n, t) {
                if (B(e.size))
                    if (B(n) && B(t)) {
                        ...
                        if (B(n) && e.size < n) return [!1, _(n)];
                        if (B(t) && e.size > t) return [!1, I(t)]
                    }
                return [!0, null]
            }
            ...
            function W() {
                ...
                return function(e) {
                    ...
                    return n.some(function(n) {
                        return !K(e) && n && n.apply(void 0, [e].concat(r)), K(e)
                    })
                }
            }
            ...
            var N = ["children"],
                G = ["open"],
                V = ["refKey", "role", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"],
            ...
            var ie = (0, r.forwardRef)(function(e, n) {
                ...
                }, [i]), r.createElement(r.Fragment, null, t(te(te({}, a), {}, {
                    open: i
                })))
            });
            ...
            ie.defaultProps = ae, ie.propTypes = {
                children: i().func,
            ...
            function ue() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    C = (0, r.useMemo)(function() {
                        return function(e) {
                            if (B(e)) return Object.entries(e).reduce(function(e, n) {
                                var t = F(n, 2),
                                    r = t[0],
                                    o = t[1];
                            ...
                            return B(e) ? [{
                                ...
                                accept: Object.entries(e).filter(function(e) {
                                    var n = F(e, 2),
                                        ...
                                        r = n[1],
                                        o = !0;
                                    return $(t) || (console.warn('Skipped "'.concat(t, '" because it is not a valid MIME type. Check https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types for a list of valid MIME types.')), o = !1), Array.isArray(r) && r.every(q) || (console.warn('Skipped "'.concat(t, '" because an invalid file extension was provided.')), o = !1), o
                                }).reduce(function(e, n) {
                                    var t = F(n, 2),
                                        r = t[0],
                                        o = t[1];
                    ...
                    I = (0, r.useRef)(null),
                    _ = (0, r.useRef)(null),
                    N = Q((0, r.useReducer)(le, ce), 2),
                    G = N[0],
                    Z = N[1],
                    ee = G.isFocused,
                    ne = G.isFileDialogActive,
                    ie = (0, r.useRef)("undefined" !== typeof window && window.isSecureContext && b && "showOpenFilePicker" in window),
                    ue = function() {
                        !ie.current && ne && setTimeout(function() {
                            _.current && (_.current.files.length || (Z({
                                type: "closeDialog"
                            }), T()))
                        }, 300)
                    };
                (0, r.useEffect)(function() {
                    return window.addEventListener("focus", ue, !1),
                        function() {
                ...
                var fe = (0, r.useRef)([]),
                    pe = function(e) {
                        I.current && I.current.contains(e.target) || (e.preventDefault(), fe.current = [])
                    };
                (0, r.useEffect)(function() {
                    return w && (document.addEventListener("dragover", U, !1), document.addEventListener("drop", pe, !1)),
                        function() {
                            w && (document.removeEventListener("dragover", U), document.removeEventListener("drop", pe))
                        }
                }, [I, w]), (0, r.useEffect)(function() {
                    return !o && h && I.current && I.current.focus(),
                        function() {}
                }, [I, h, o]);
                var de = (0, r.useCallback)(function(e) {
                        P ? P(e) : console.error(e)
                    }, [P]),
                    me = (0, r.useCallback)(function(e) {
                        e.preventDefault(), e.persist(), Fe(e), fe.current = [].concat(J(fe.current), [e.target]), Y(e) && Promise.resolve(i(e)).then(function(n) {
                            if (!K(e) || k) {
                                var t = n.length,
                                    r = t > 0 && function(e) {
                                        var n = e.files,
                    ...
                    ge = (0, r.useCallback)(function(e) {
                        e.preventDefault(), e.persist(), Fe(e);
                        var n = fe.current.filter(function(e) {
                                return I.current && I.current.contains(e)
                            }),
                            t = n.indexOf(e.target); - 1 !== t && n.splice(t, 1), fe.current = n, n.length > 0 || (Z({
                            type: "setDraggedFiles",
                            isDragActive: !1,
                            isDragAccept: !1,
                            isDragReject: !1
                    ...
                    ye = (0, r.useCallback)(function(e, n) {
                        var t = [],
                            r = [];
                    ...
                    be = (0, r.useCallback)(function(e) {
                        e.preventDefault(), e.persist(), Fe(e), fe.current = [], Y(e) && Promise.resolve(i(e)).then(function(n) {
                            K(e) && !k || ye(n, e)
                        }).catch(function(e) {
                            return de(e)
                        }), Z({
                    ...
                    he = (0, r.useCallback)(function() {
                        if (ie.current) {
                            ...
                            window.showOpenFilePicker(e).then(function(e) {
                                ...
                                var n;
                                (n = e) instanceof DOMException && ("AbortError" === n.name || n.code === n.ABORT_ERR) ? (T(e), Z({
                                    type: "closeDialog"
                                })) : ! function(e) {
                                    return e instanceof DOMException && ("SecurityError" === e.name || e.code === e.SECURITY_ERR)
                                }(e) ? de(e) : (ie.current = !1, _.current ? (_.current.value = null, _.current.click()) : de(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided.")))
                            })
                        } else _.current && (Z({
                            type: "openDialog"
                        }), R(), _.current.value = null, _.current.click())
                    }, [Z, R, T, b, ye, de, z, u]),
                    we = (0, r.useCallback)(function(e) {
                        I.current && I.current.isEqualNode(e.target) && (" " !== e.key && "Enter" !== e.key && 32 !== e.keyCode && 13 !== e.keyCode || (e.preventDefault(), he()))
                    }, [I, he]),
                    ...
                    ke = (0, r.useMemo)(function() {
                        return function() {
                            ...
                            return te(te(re({
                                ...
                                onBlur: Ae(W(c, Oe)),
                                onClick: je(W(u, xe)),
                                onDragEnter: Ee(W(l, me)),
                                onDragOver: Ee(W(s, ve)),
                                onDragLeave: Ee(W(f, ge)),
                                onDrop: Ee(W(p, be)),
                    ...
                    }, [I, we, De, Oe, xe, me, ve, ge, be, O, j, o]),
...
//# sourceMappingURL=1711.daca979b.chunk.js.map